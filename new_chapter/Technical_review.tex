...
墨卡托投影法（英语：Mercator projection），又称麦卡托投影法，是一种保证角度不变的圆柱形地图投影方式，因此也被称为等角正切圆柱投影。它以本初子午线与赤道交点为投影坐标原点，将赤道投影为X轴，将本初子午线投影为Y轴，从而构成墨卡托平面直角坐标系。\citenjup{MercatoProjection}此投影法之所以被称为墨卡托投影，是因为其作者为法兰德斯地理学家杰拉杜斯·墨卡托。1569年，他以此投影法为坐标基础绘制了一幅长202 公分、宽124 公分的世界地图。由于角度不变形的保证，该地图经纬线于任何位置皆垂直相交。从而大大降低了地图信息的复杂性。

Web墨卡托投影法是方便地图数据在网络上计算传输的，对原生墨卡托投影的一种简化变形的坐标投影法。它与原生墨卡托投影的一个重要区别是：Web墨卡托投影忽略了地球作为一个椭球体的客观事实，出于计算简单，直接将地球视作一个标准球体，这就造成了Web墨卡托投影法与原生墨卡托投影法存在0.33\%的精度差别。它的计算公式较之于墨卡托投影也简化了很多，在本文的详细设计章节的局部地图更新功能设计中，就是对公式的等价变换实现，完成了WGS-84坐标到Web墨卡托坐标的变换，从而将经纬度转换为瓦片坐标，作为局部更新的位置依据的。
