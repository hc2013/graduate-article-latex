...
\hline
\textbf{异常流程}&\tabincell{l}{2a.经纬度大小值错误，前端应自动检测并警告 \\ 3a.指定矩形范围太小，在较小的zoom下无法更新瓦片,服务端应发现错误并返回告知用户 \\ 5a. 用户选择的文件格式错误，则前端对用户发出警告 \\ 5b.用户选择的文件中并没有指定bounding-box中的数据，服务端应返回错误报告并提醒用户更改文件}\\
\hline
\end{tabular}}
