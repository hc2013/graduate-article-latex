...
\englishkeywords{Geographic data, trajectory data, tile data, vantage point tree, vector tile, trajectory index structure, trajectory similarity retrieval, visualization}
\end{englishabstract}
